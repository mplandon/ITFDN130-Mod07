...
-- 2020-08-20,MichelleRoy,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MichelleRoy')
	 Begin 
	  Alter Database [Assignment07DB_MichelleRoy] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MichelleRoy;
	 End
	Create Database Assignment07DB_MichelleRoy;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MichelleRoy;
...
Order by C.CategoryName, DatePart(Month, InventoryDate), Sum(I.[Count]);
Go
